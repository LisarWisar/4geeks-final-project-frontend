...
import styles from "../../styles/UserFrontPage.module.css"
                ...
                <div>
                    <div className="container-fluid">
                        <div className="py-3 d-lg-flex">
                            <div className={`${styles.appointmentCardDate} d-flex flex-column align-items-center py-1`}>
            ...
            <div className={styles.vetBodyDiv}>
                <div className="container-fluid">
                    <div className="row pt-5 d-flex justify-content-center">
                        ...
                        <div className={`col-8 ${styles.vetPreviewCard} my-4 p-4`}>
                            <p>Your pets</p>
                            <PetCards />
